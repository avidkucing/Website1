...
?>
<head>
	<title>Formulir Input Data Bahan Kemas</title>
...
<body>
	<div id="main">
		<div id="login">
			<h2>Formulir Input Data Bahan Kemas</h2>
		<hr/>
		<?php
			...
			echo form_label('Kode Bahan Kemas : ');
			echo"<br/>";
			echo form_input('kode');
			echo"<br/>";
			echo form_label('Nama Bahan Kemas : ');
			echo"<br/>";
