...
<body>
	...
	<?php	
		...
		echo form_label('Kode Bahan:', '', $label_attr);
			...
			echo my_form_dropdown('kode', $kode_rows, $lpb[0]['Kode_Bahan'], '', '', 'class="form-control kodebahan"'); 
			echo "</div>";
		echo "</div>";
		...
		echo form_label('Nama Bahan:', '', $label_attr);
			echo "<div class='col-sm-8'>";
			echo form_dropdown('nama', $nama_rows, $lpb[0]['Nama_Bahan'], 'class="form-control namabahan"');
			echo "</div>";
		echo "</div>";
		...
		echo form_label('Nama Supplier:', '', $label_attr);
			echo "<div class='col-sm-8'>";
			echo form_dropdown('supp', $supp_rows, $lpb[0]['Nama_Supplier'], 'class="form-control supplier"'); 
			echo "</div>";
		echo "</div>";
		...
		echo form_label('Nama Manufacturer:', '', $label_attr);
			echo "<div class='col-sm-8'>";
			echo form_dropdown('manu', $manu_rows, $lpb[0]['Nama_Manufacturer'], 'class="form-control manufaktur"');
			echo "</div>";
		echo "</div>";
